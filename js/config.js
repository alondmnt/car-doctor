...
const UNLOCK_TIERS = [
  ...
  { coins: 85, key: 'planetTectonic', label: 'Tectonic repair!', icon: '🌋', items: [],
    showcase: { vehicle: 'planet', fault: 'tectonicVolcanic' } },
  { coins: 90, key: 'planetOcean', label: 'Ocean cleanup!', icon: '🌊', items: [],
    showcase: { vehicle: 'planet', fault: 'oceanCleanup' } },
  { coins: 95, key: 'planetTerraforming', label: 'Terraforming!', icon: '🌱', items: [],
