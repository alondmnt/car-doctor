...
const UNLOCK_TIERS = [
  ...
  { coins: 75, key: 'planetSatellite', label: 'Satellite network!', icon: '📡', items: [],
    showcase: { vehicle: 'planet', fault: 'satelliteNetwork' } },
  { coins: 79, key: 'planetAsteroid', label: 'Asteroid defence!', icon: '☄️', items: [],
    showcase: { vehicle: 'planet', fault: 'asteroidDefence' } },
  { coins: 83, key: 'planetTectonic', label: 'Tectonic repair!', icon: '🌋', items: [],
    showcase: { vehicle: 'planet', fault: 'tectonicVolcanic' } },
  { coins: 87, key: 'planetOcean', label: 'Ocean cleanup!', icon: '🌊', items: [],
    showcase: { vehicle: 'planet', fault: 'oceanCleanup' } },
  { coins: 91, key: 'planetTerraforming', label: 'Terraforming!', icon: '🌱', items: [],
    showcase: { vehicle: 'planet', fault: 'forest' } },
  { coins: 96, key: 'planetCityExpansion', label: 'City expansion!', icon: '🏙️', items: [],
    showcase: { vehicle: 'planet', fault: 'city' } },
  { coins: 100, key: 'planetSatelliteExpansion', icon: '🛰️', label: 'Satellite upgrade!', items: [],
    showcase: { vehicle: 'planet', fault: 'satelliteNetwork' } },
  { coins: 111, key: 'ultimateMode', icon: '🌟', label: 'Ultimate Garage!', items: [],
    showcase: { vehicle: 'planet' } },
];
